...
where: {\displaystyle n}n is the number of keys, {\displaystyle m}m is the number of buckets, {\displaystyle b_{j}}b_{j} is the number of items in bucket {\displaystyle j}j
